              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <div className="text-center p-4 bg-gradient-to-br from-palette-celestial-blue/10 to-blue-50 rounded-xl">
                    <div className="text-3xl font-bold text-palette-celestial-blue mb-1">
                      15+
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-palette-celestial-blue to-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="text-lg px-8 py-6 bg-white text-palette-celestial-blue hover:bg-gray-100 transition-all duration-300"
            >
              <Phone className="mr-2 rtl:mr-0 rtl:ml-2" size={20} />
              {tContact("hero.callNow")}
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 py-6 border-white text-white hover:bg-white hover:text-palette-celestial-blue transition-all duration-300"
            >
