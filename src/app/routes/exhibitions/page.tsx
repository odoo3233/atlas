...
const mockExhibitions = [
  {
    ...
    description:
      "Showcasing the latest technology innovations from China and Saudi Arabia with a focus on AI, robotics, and smart city solutions.",
  ...
  },
  {
    ...
    description:
      "Connecting manufacturing businesses from both countries for collaboration and knowledge exchange in industrial innovation.",
  ...
  },
  {
    ...
    description:
      "Exploring sustainable energy solutions and partnerships between Saudi Arabia and China in renewable energy technologies.",
  ...
  },
  {
    ...
    description:
      "Annual trade fair showcasing products and services from both countries across multiple industries.",
  ...
  },
  {
    ...
    description:
      "Bringing together healthcare professionals and companies to explore medical innovations and partnerships.",
      ...
      <section className="bg-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl max-w-2xl">
            Discover our upcoming and past exhibitions and events connecting
            businesses between China and Saudi Arabia. Register to attend or
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8">
              If you're interested in exhibiting your products or services at
              one of our upcoming events, please contact our exhibitions team
