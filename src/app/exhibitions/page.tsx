...
export default function ExhibitionsPage() {
  ...
  return (
    <>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-6 border-white text-white hover:bg-white hover:text-atlas-dark"
              >
      ...
      {/* Exhibitions List */}
      <section className="py-12 bg-atlas-brown-50">
        <div className="container mx-auto px-4">
          {filteredExhibitions.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-xl text-atlas-brown-600">
                ...
                return (
                  ...
                  >
                    <div className="relative h-64 w-full bg-gray-200">
                      ...
                      {/* Status badge */}
                      <div className={`absolute top-4 right-4 text-white px-3 py-1 rounded-full text-sm font-medium ${isUpcoming ? 'bg-green-500' : 'bg-gray-500'}`}>
                        {isUpcoming ? "الفعاليات القادمة" : "الفعاليات السابقة"}
                      </div>
                    </div>

                    <div className="p-6">
                      <h3 className="text-xl font-semibold mb-3 text-atlas-dark">
                        {exhibition.name}
                      </h3>
                      <p className="text-atlas-brown-600 mb-4">
                        {exhibition.description}
                      </p>

                      <div className="space-y-2 mb-6">
                        <div className="flex items-center text-atlas-brown-700">
                          <Calendar className="h-5 w-5 mr-2 text-atlas-gold-600" />
                          <span>
                        ...
                        <div className="flex items-start text-atlas-brown-700">
                          <MapPin className="h-5 w-5 mr-2 mt-1 text-atlas-gold-600" />
                          <span>{exhibition.location}</span>
                        </div>
                        <div className="flex items-center text-atlas-brown-700">
                          <Users className="h-5 w-5 mr-2 text-atlas-gold-600" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-atlas-dark">
              مهتم بالمشاركة في المعارض؟
            </h2>
            <p className="text-lg text-atlas-brown-700 mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact">
                <Button size="lg" className="btn-primary-gradient">تواصل معنا</Button>
              </Link>
              <Link href="/about">
