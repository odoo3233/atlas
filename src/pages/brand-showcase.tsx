...
import {
  ...
  AtlasLogoAnimated,
  AtlasLogoMinimal,
} from "../components/AtlasLogo";
import {
  AtlasLogoAdvanced,
  AtlasLogoLoading,
} from "../components/AtlasLogoAdvanced";
import {
  AtlasButton,
  AtlasCard,
  AtlasBadge,
    ...
    <div className="min-h-screen bg-gradient-to-br from-atlas-gold-50 to-white dark:from-atlas-brown-900 dark:to-atlas-dark">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <AtlasCard
            title="Default Logo"
            description="Standard logo with company name"
          >
          ...
          <AtlasCard
            title="Animated Logo"
            description="Logo with smooth animations"
          >
            <div className="flex justify-center py-8">
          ...
          <AtlasCard
            ...
            description="Hover for advanced effects"
          >
            <div className="flex justify-center py-8">
          ...
          <AtlasCard
            title="Minimal Logo"
            description="Simplified version without text"
          >
            <div className="flex justify-center py-8">
        ...
        {/* Buttons */}
        <div className="mb-12">
          <h3 className="text-2xl font-semibold text-atlas-brown-800 dark:text-atlas-gold-300 mb-6">
            Buttons
          </h3>
