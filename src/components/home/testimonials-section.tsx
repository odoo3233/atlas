  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "أطلس الشرق غيرت مسار أعمالنا بالكامل. من خلال معارضهم المتميزة، تمكنا من الوصول لأكثر من 500 شريك صيني جديد وزيادة مبيعاتنا بنسبة 300%.",
      image: "👨‍💼",
    ...
    },
    {
      ...
      company: "مجموعة جدة الاستثمارية",
      rating: 5,
      text: "الخدمة الاستثنائية والاحترافية العالية جعلتنا نحقق شراكات استراتيجية مع أكبر الشركات الصينية. فريق أطلس الشرق محترف ومتفاني.",
      image: "👩‍💼",
      results: "50+ شراكة جديدة"
    },
    {
      name: "محمد الشهري",
      position: "رئيس مجلس الإدارة", 
      company: "شركة الشرق الأوسط للتكنولوجيا",
      rating: 5,
      text: "بفضل أطلس الشرق، تمكنا من دخول السوق الصيني بنجاح باهر. خبرتهم العميقة وشبكة علاقاتهم الواسعة كانت المفتاح لنجاحنا.",
      image: "👨‍💻",
      results: "دخول ناجح للسوق الصيني"
    }
  ];
