    ...
    <div className={`inline-flex flex-col items-center ${className}`}>
      ...
      >
        ...
        <g className={variant === "animated" ? "animate-atlas-pulse" : ""}>
          ...
          <circle cx="100" cy="100" r="55" fill={`url(#${logoId}-radial)`} />
...
export const AtlasLogoAnimated: React.FC<Omit<AtlasLogoProps, "variant">> = (
  props,
) => <AtlasLogo {...props} variant="animated" />;

// Minimal Logo Variant (no animations, simplified)
export const AtlasLogoMinimal: React.FC<Omit<AtlasLogoProps, "variant">> = (
  props,
