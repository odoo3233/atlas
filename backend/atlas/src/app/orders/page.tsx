    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="bg-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('orders.title')}</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <section className="bg-white p-8 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-6">{t('orders.trackOrder')}</h2>
            ...
            {!orderResult ? (
              <form onSubmit={handleTrackOrder} className="space-y-4">
                ...
                <div>
                  <label htmlFor="orderEmail" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('orders.email')}
                  </label>
                  <input
                    type="email"
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold">{t('orders.orderDetails')}</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-md">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium capitalize">{orderResult.status}</p>
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">
                    ${orderResult.items.reduce((sum: number, item: any) => sum + (item.price * item.quantity), 0).toFixed(2)}
                  </p>
                </div>
              </div>
            )}
          ...
          <section className="bg-white p-8 rounded-lg shadow-md">
            ...
            {formSubmitted ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold mb-2">{t('orders.thankYou')}</h3>
