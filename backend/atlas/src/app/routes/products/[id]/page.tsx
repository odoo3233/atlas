...
const mockProducts = [
  {
    ...
    description: "High-performance industrial machinery for manufacturing plants with advanced automation features and energy-efficient operation.",
    price: 15000,
    category: "machinery",
  ...
  },
  {
    ...
    description: "IoT sensors for smart factory monitoring and automation with real-time data collection and analysis capabilities.",
    price: 2500,
  ...
  },
  {
    ...
    description: "High-efficiency solar panels for commercial buildings with advanced energy conversion and storage solutions.",
    price: 8000,
    category: "energy",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button onClick={handlePrintBarcode} variant="outline" className="flex items-center">
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 md:p-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button 
                    ...
                    className="px-6"
                  >
                    {formStatus === "submitting" ? "Submitting..." : t('orders.form.submit')}
                  </Button>
                </div>
              </form>
            )}
