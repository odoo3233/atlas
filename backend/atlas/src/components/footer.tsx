        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gradient-primary bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
                  {t('companyName') || 'أطلس الشرق'}
                </h3>
                <p className="text-lg text-gray-300 font-medium">
                  {t('companyNameEn') || 'Atlas Al-Sharq'}
                </p>
              </div>
            </div>
            <p className="text-gray-300 leading-relaxed text-lg">
              {t('description') || 'شركة رائدة في مجال المعارض والتجارة الدولية، نربط الشركات بالأسواق العالمية من خلال خدمات متكاملة ومتخصصة'}
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <Link href="/about" className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300 hover:text-white transition-colors duration-300 group">
                ...
                <span className="text-lg">{t('about') || 'من نحن'}</span>
              </Link>
              <Link href="/services" className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300 hover:text-white transition-colors duration-300 group">
                ...
                <span className="text-lg">{t('services') || 'خدماتنا'}</span>
              </Link>
              <Link href="/exhibitions" className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300 hover:text-white transition-colors duration-300 group">
                ...
                <span className="text-lg">{t('exhibitions') || 'المعارض'}</span>
              </Link>
              <Link href="/products" className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300 hover:text-white transition-colors duration-300 group">
                ...
                <span className="text-lg">{t('products') || 'متجر أطلس الشرق'}</span>
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300">
                ...
                <div>
                  <p className="text-lg font-medium">{t('contact.info.address') || 'الرياض، المملكة العربية السعودية'}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300">
                ...
                <div>
                  <p className="text-lg font-medium">{t('contact.info.phone') || '+966 11 123 4567'}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300">
                ...
                <div>
                  <p className="text-lg font-medium">{t('contact.info.email') || 'info@atlas-alsharq.com'}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3 rtl:space-x-reverse text-gray-300">
                ...
                <div>
                  <p className="text-lg font-medium">{t('contact.info.hours') || 'الأحد - الخميس: 8:00 ص - 6:00 م'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              {t('newsletterDesc') || 'احصل على آخر الأخبار والعروض'}
            </p>
            <div className="space-y-4">
        ...
        <div className="mt-16 pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <p className="text-gray-300 text-lg">
              {t('copyright') || 'جميع الحقوق محفوظة © 2025 أطلس الشرق'}
            </p>
            <button
              onClick={scrollToTop}
